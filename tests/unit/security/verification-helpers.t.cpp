...
//added_GM, by liupenghui
  ...
  BOOST_CHECK(!verifySignature(data, tpm, signingInfo.getSignerName(), keyType, DigestAlgorithm::SHA256));
  BOOST_CHECK(!verifySignature(interest, tpm, signingInfo.getSignerName(), keyType, DigestAlgorithm::SHA256));
  ...
  BOOST_CHECK(verifySignature(data, tpm, signingInfo.getSignerName(), keyType, DigestAlgorithm::SHA256));
  BOOST_CHECK(verifySignature(interest, tpm, signingInfo.getSignerName(), keyType, DigestAlgorithm::SHA256));
  BOOST_CHECK(verifySignature(interestOldFormat, tpm, signingInfo.getSignerName(), keyType, DigestAlgorithm::SHA256));
#else
